...
class FitsDataProvider(BaseDataProvider):
    """
    Data provider for fits images, supports gray scale and colored images.
    ...
    :param a_min: (optional) min value used for clipping
    :param a_max: (optional) max value used for clipping
    :param data_suffix: suffix pattern for the data images. Default '_image.fits'
    :param mask_suffix: suffix pattern for the label images. Default '_mask.fits'
    ...
    def _load_file(self, path, dtype=np.float32):
        ...
        image_data = np.array(hdu_image[0].data)
        return np.array(image_data, dtype)
    ...
    def _next_data(self):
        ...
        label_name = image_name.replace(self.data_suffix)
